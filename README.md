...
With a custom font, duh. Arti has her own genotheta font, but as far as I know, that’s ~~private~~ [***published on her cool ass site!!!!!!***](https://artifyber.xyz/?m=converters&i=genotheta). So I made my own font. With blackjack and hookers. The numerals are encoded on the first 32 characters of the Private Use Area, so they’re neat and easy to work with. ~~I’ll sure eventually properly publish the font family somewhere, but for now you can just download ArtitypeD.ttf from the source and install it locally, I guess~~ [***Grab the font while it’s hot***](http://rarit.ee/artitype.htm) (KittyMath does not require the font to be installed to work or display properly).
